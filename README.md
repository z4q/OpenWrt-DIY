...
**MIPS 设备推荐使用 Padavan 固件：** [Padavan 仓库 1](https://github.com/hanwckf/rt-n56u) [Padavan 仓库 2](https://opt.cn2qq.com/padavan/)
...
3. **默认 IP 为：192.168.1.1，默认密码：password；2021年2月26日起默认 IP 调整为：192.168.2.1，默认密码：password。**
